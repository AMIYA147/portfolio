      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {projects.map((project) => {
            ...
            return (
              <GlareCard key={project.id} className="p-6 md:p-8 flex flex-col justify-between h-full bg-cyber-card border-white/[0.05]">
                <div>
                  {/* Card Header Info */}
                ...
                <div className="flex items-center gap-3 border-t border-white/[0.05] pt-4 mt-auto">
                  <Magnet range={40} strength={0.3}>
                    <a
                      ...
                      className="px-4 py-2 rounded-full border border-white/[0.08] bg-white/[0.01] hover:bg-white/[0.05] text-slate-300 hover:text-white text-xs font-bold font-mono transition-all duration-300 flex items-center gap-1.5"
                    >
                  ...
                  {project.status === "deployed" ? (
                    <Magnet range={40} strength={0.3}>
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="px-4 py-2 rounded-full bg-gradient-to-r from-cyber-blue/10 to-cyber-purple/10 border border-cyber-blue/30 text-cyber-blue hover:from-cyber-blue hover:to-cyber-purple hover:text-white text-xs font-bold font-mono transition-all duration-300 flex items-center gap-1.5 hover:shadow-cyber-glow"
                      >
                    ...
                    <span
                      className="px-4 py-2 rounded-full border border-rose-500/20 bg-rose-500/5 text-rose-400/60 text-xs font-bold font-mono flex items-center gap-1.5 cursor-not-allowed select-none opacity-60"
                    ...
                    <span
                      className="px-4 py-2 rounded-full border border-white/[0.05] bg-white/[0.02] text-slate-500 text-xs font-bold font-mono flex items-center gap-1.5 cursor-not-allowed select-none opacity-50"
